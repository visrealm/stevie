...
***************************************************************
* Textmode (80 columns, 48 rows) - F18A
*--------------------------------------------------------------
* ; VDP#0 Control bits
* ;      bit 3=1: 48/60 row mode enable (0x08)
* ;      bit 2=1: M4 \ TEXT MODE
* ;      bit 6=0: M3 | Graphics 1 mode
* ;      bit 7=0: Disable external VDP input
***************************************************************
stevie.80x48:
        byte  >0c,>f0,>00,>3c,>05,>69,>05,SPFCLR,0,80
...
***************************************************************
stevie.80x60:
        byte  >0c,>f0,>00,>3c,>04,>69,>05,SPFCLR,0,80
