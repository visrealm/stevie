* FILE......: equ.f18a.4880.asm
* Purpose...: F18a 48x80 mode (with sprite cursor/rulers)
...
vdp.tat.size              equ  48*80   ; VDP TAT size 80 columns, 48 rows
...
spvmod  equ   bankx.vdptab + 20     ; Video mode.   See VIDTAB for details.
